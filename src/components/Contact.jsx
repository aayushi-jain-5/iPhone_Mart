                    ...
                    <div className="col-md-6">
                        <form >
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="exampleForm" placeholder="Aayushi Jain"/>
</div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Email address</label>
                                <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="aayushi@example.com"/>
</div>
                                <div class="mb-3">
